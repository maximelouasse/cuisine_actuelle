...
export class ListRecipePageComponent implements OnInit {
    ...
    public currentListSearchFilters: any[] = [];
    ...
    */
    ...
    public addSearchFilter = () => {
        this.currentListSearchFilters.push(this.queryField.value);
        this.displaySearchList = false;
        this.listFilters.ingredients = this.currentListSearchFilters;
        this.queryField.setValue(null);
        this.filterRecipe();
    }

    public deleteSearchFilter = (key) => {
        this.currentListSearchFilters.splice(key, 1);
        this.listFilters.ingredients = this.currentListSearchFilters;
        this.filterRecipe();
    }
    //
